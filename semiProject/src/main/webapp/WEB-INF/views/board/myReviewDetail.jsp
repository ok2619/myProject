...
<div class="page-main">
	...
	<p class="float_left view_font2">조회수 : ${board.hit}</p>
		...
		onclick="location.href='myReviewUpdateForm.do?board_num=${board.board_num}'" class="btn btn-default btn-sm">
		...
		<script type="text/javascript">
			...
			delete_btn.onclick=function(){
				...
				if(choice){
					location.replace('myReviewDelete.do?board_num=${board.board_num}');
				}
			};
		</script>		
		</c:if>
		<%--수정/삭제 기능 끝 --%>		
		<input type="button"  class="btn btn-default btn-sm" value="목록" onclick="location.href='myReview.do'">
